...
import { processLoginBody, processRegisterBodySchema } from "../@types/index.js";
...
router.post("/login", validateBody(processLoginBody), async (req, res, next) => {
...
router.post("/register", validateBody(processRegisterBodySchema), async (req, res, next) => {
    let username = req.body.username;
    let password = req.body.password;
