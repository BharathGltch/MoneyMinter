...
import { concatAudioFiles, concatAudioFilesWithoutSilence, concatAudioFilesWithSilence, generateSilenceFiles, padAudio } from "./ffmpeg.js";
...
export async function textToSpeechWithSilence(srtFilePath:string,coinId:string){
...
//parse audio parts
 ...
 async function parseSrt(srtFilePath:string){
...
async function generateVoiceOvers(subtitles:Subtitle[],coinId:string){
        const audioFiles=[];
...
function calculateSilenceDurations(subtitles:Subtitle[]){
